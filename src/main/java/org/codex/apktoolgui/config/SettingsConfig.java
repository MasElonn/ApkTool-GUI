...
public class SettingsConfig {
    ...
    public static final String DEFAULT_ADB_PATH = isWindows() ? "lib/platform-tools/adb.exe" : "lib/platform-tools/adb";
    public static final String DEFAULT_ZIPALIGN_PATH = "lib/zipalign";
    public static final String DEFAULT_APKSIGNER_PATH = "lib/apksigner.jar";
